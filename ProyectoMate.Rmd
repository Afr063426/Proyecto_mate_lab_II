...
DecrementoM <- function(Edad, hombre, antiguedad, ultimo_salario, tasa_descuento, tasa_cre_salario, n = 0) {
  ...
  vectorAnualmensual <-Inflacion sort(rep(c(0:9), 12))
  for (i in edades) {
    if (n != 0) {
...
#Liquidacion
hombres_liquidacion <- c(suma_invalidez_h_18,suma_jublicacion_h_18,suma_muerte_h_18,pensionados_h,suma_total_h_18)
mujeres_liquidacion <- c(suma_invalidez_m_18,suma_jublicacion_m_18,suma_muerte_m_18,pensionados_m,suma_total_m_18)
