...
```{r}
cotizacionfutura <-
  function(Edad, hombre, ultimo_salario, t,porcentaje_aporte=1) {
    v <- (1) / (1 + 0.07 )
    t<-min(85,t)
    if (hombre) {
      t<-min(85-Edad,t)
...
SalariosM<-mapply( cotizacionfutura,  afil_mujeres$Edad, FALSE, afil_mujeres$Salario,2)
SalariosH<-mapply( cotizacionfutura,  afil_hombres$Edad, TRUE, afil_hombres$Salario,2)
