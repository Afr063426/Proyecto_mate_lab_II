...
```{r}
costos_plan <- c(suma_total_h, suma_total_m, suma_total_h + suma_total_m)
...
plan <- c("Hombres", "Mujeres", "Totales")
tabla_resultados <- data.frame("Costos" = plan, "Costos plan" = costos_plan, "Costos liquidación" = costos_liquidacion, "Proporciones" = proporciones)
