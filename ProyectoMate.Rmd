...
-`salario_ref`: salario de referencia
-`antiguedad`: antigüedad de la persona en la Compañía

```{r}

# Implementación del algoritmo descrito en Racinello (1988)

costo_afiliado_estoc <- function(x, sexo, salario_ref, antiguedad){ 
  ...
  if(u > q) {# Criterio del algoritmo en caso de jubilación obligatoria
    ...
    Kx <- rLife(1, q4_prima, xi, type = "Kx")
