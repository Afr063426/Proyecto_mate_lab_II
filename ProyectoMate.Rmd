...
DecrementosIV2 <- function(Edad, hombre, antiguedad, ultimo_salario, tasa_descuento, tasa_cre_salario, decremento) {
...
```{r}
# Prueba de ambas funciones con el primer individuo
# DecrementosIV(afil_hombres$Edad[1], TRUE, afil_hombres$Antiguedad[1], afil_hombres$Salario[1], 0.07, 0, 1)
