...
# Por invalidez
salida_invalidez_h <- DecrementosIV2(edades, TRUE, antiguedades, salarios, tasa_descuento, tasa_crecimiento_r, 1)

# Por jubilacion
salida_jubilacion_h <- DecrementosIV2(edades, TRUE, antiguedades, salarios, tasa_descuento, tasa_crecimiento_r, 2)

# Por muerte
salida_muerte_h <- DecrementoM2(edades, TRUE, antiguedades, salarios, tasa_descuento, tasa_crecimiento_r)
