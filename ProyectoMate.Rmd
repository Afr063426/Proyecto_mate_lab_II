...
costo_afiliado_estocastico <- function(x, sexo, salario, antiguedad, cant_simulaciones) {
  ...
  if (cant_pensiones_edad_max < cant_simulaciones) {
    ...
    if (identical(tiempos_invalidez, numeric(0))) {
      tiempos_invalidez <- 0
    }
    ...
    if (identical(tiempos_jubilacion, numeric(0))) {
      tiempos_jubilacion <- 0
    }
    ...
    if (identical(tiempos_muerte, numeric(0))) {
      tiempos_muerte <- 0
    }
...
attach(afil_hombres)
# prueba <- liquidacion(Edad[2], Salario[2], 0, 0.07, inflacion, aumento_real, porcentaje_aporte, "M")
afil_hombres$Estimacion_Liquidacion <- unlist(future_mapply(
  FUN = liquidacion, edad = Edad, salario_actual = Salario,
  antiguedad = Antiguedad, i = 0.07, inflacion = inflacion, aumento_real = aumento_real, porcentaje_aporte = porcentaje_aporte,
  sexo = "M"
))
attach(afil_mujeres)
afil_mujeres$Estimacion_Liquidacion <- unlist(future_mapply(
  FUN = liquidacion, edad = Edad, salario_actual = Salario,
  antiguedad = Antiguedad, i = 0.07, inflacion = inflacion, aumento_real = aumento_real, porcentaje_aporte = porcentaje_aporte,
  sexo = "F"
))
