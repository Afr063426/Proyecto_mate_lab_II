...
#  # qxs <- cbind(qxt1(MDListaDeTablasMujeres[[x+1]], x=0:115, t=1, decrement=1),
#  #         qxt1(MDListaDeTablasMujeres[[x+1]], x=0:115, t=1, decrement=2),
#  #         qxt1(MDListaDeTablasMujeres[[x+1]], x=0:115, t=1, decrement=3),
#  #         qxt1(MDListaDeTablasMujeres[[x+1]], x=0:115, t=1, decrement=4),
#  #         qxt1(MDListaDeTablasMujeres[[x+1]], x=0:115, t=1))
# 
...
#traer al presente 
    if (hombre) {
      ultimo_salario * ((1 + 0.04)*(1+0.025))^(0:(85-Edad))*12*
        pxt1(MDListaDeTablasHombres[[(85-Edad)]], x = (85-Edad), t = 1)
      } else {
        ultimo_salario * ((1 + 0.04)*(1+0.025))^(0:(85-Edad))*12*
          pxt1(MDListaDeTablasMujeres[[(77 - Edad)]], x = (77 - Edad), t = 1)
      }  
    }
