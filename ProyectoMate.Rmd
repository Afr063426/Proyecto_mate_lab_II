...
vectorMensual<-(seq(1/12, (115-Edad+1), 1/12))
    ...
    PV <- suma1*
      v^k*pxt(MDListaDeTablasHombres
[[Edad+1]], x=edad ,t=k)
*qxt(MDListaDeTablasHombres
[[Edad+1]], x=edad ,t=k, decrement=1)
...
vectorMensual<-(seq(1/12, (115-Edad+1), 1/12))
    ...
    PV <- suma1*
      v^k*pxt(MDListaDeTablasMujeres
[[Edad+1]], x=edad ,t=k)
*qxt(MDListaDeTablasMujeres
[[Edad+1]], x=edad ,t=k, decrement=1)
